                ...
                <div class="col-sm-8 col-sm-offset-3 col-md-4 col-md-offset-4">
                    <div class="demo-form-wrapper">
                        ...
                        <div class="md-form-group">
                            ...
                            <input id="lc_id" class="md-form-control" type="text" value="{{ $do_detail->lc_id }}">
                            <label class="md-control-label"></label>
                        </div>
                        <div class="md-form-group">
                            <label for="lc_ammend_no">Ammendment No</label>
                            <input id="lc_ammend_no" class="md-form-control" type="text" value="{{ $do_detail->lc_ammend_no }}">
                            <label class="md-control-label"></label>
                        </div>
                        <div class="md-form-group">
                            <label for="approved_by">Do Approved By</label>
                            <input id="approved_by" class="md-form-control" type="text" value="{{ $do_detail->do_finally_approve }}" required>
                            <label class="md-control-label"></label>
                        </div>
                        <div class="md-form-group">
                            <label for="payment_period">Notes</label>
                            <textarea id = "notes">{{ $do_detail->notes }}</textarea>
                            <label class="md-control-label"></label>
                        </div>
                        <div id="PItablediv">
                            <table id="PITable" border = "1" style="margin-left: -300px; margin-bottom: 10px;width: 100% ">
                                ...
                                <tr>
                                    ...
                                    <td><input size=25 type="text" name="myinput" id = "pi_id" class="pi_id"/></td>
...
<script>
    ...
    $( function() {
        ...
        var lc_number = document.getElementById("lc_id").value;
        var ammendment_no = document.getElementById('lc_ammend_no').value;
        $.ajax({
            type: "GET",
            cache: false,
                ...
                if(data.length>0){
                    ...
                    for(i = 0; i<data.length; i++){
                        ...
                        if(i==0){
                            ...
                            document.getElementById('pi_id').value = data[i].pi_id;
        ...
        $('#PITable tr').each(function (row, tr) {
            ...
            if (row > 0) {
                ...
                TableData[rowIndex] = {
                    ...
                    ,"pi_id": $(tr).find("td:eq(2) input[type='text']").val()
                    , "quantity": $(tr).find("td:eq(3) input[type='text']").val()
                    , "unit_price": $(tr).find("td:eq(4) input[type='text']").val()
                    , "total_price": $(tr).find("td:eq(5) input[type='text']").val()
                    , "requested": $(tr).find("td:eq(6) input[type='text']").val()
