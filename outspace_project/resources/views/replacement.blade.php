            ...
            <div class="layout-content-body">
                <div class="title-bar">
                    <h1 class="title-bar-title">
                        <span class="d-ib">Make A replacement</span>
                    </h1>
                ...
                <div class="row">
                    <div class="col-sm-10 col-md-10">
                        <div class="demo-form-wrapper">
                            <form class="form" method="post" action="{{ route('save_replacement') }}">
                                <div class="md-form-group">
                                    <label class="control-label" for="select_buyer">Select a Party</label>
                                    <div>
                                        <select class = "md-form-control" id="replace_buyer" name = "replace_buyer">
                                            <option disabled selected value> -- select an option -- </option>
                                            @foreach($return_partys as $return_party)
                                                <option value="{{ $return_party->buyer_id }}">{{ $return_party->buyer_name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="md-form-group">
                                    <label class="control-label" for="do_pi_no">Select a LC</label>
                                    <div>
                                        <select class = "md-form-control" id="replacement_lc" name = "replacement_lc">
                                            <option disabled selected value> -- select an option -- </option>
                                        </select>
                                        <label class="md-control-label"></label>
                                    </div>
                                ...
                                <div class="md-form-group">
                                    ...
                                    <div>
                                        <select class = "md-form-control" id="replacement_pi" name = "replacement_pi">
                                            <option disabled selected value> -- select an option -- </option>
                                        </select>
                                        <label class="md-control-label"></label>
                                    </div>
                                ...
                                <div class="md-form-group">
                                    ...
                                    <div>
                                        <input id="count" class="md-form-control" type="text" name = "count">
                                        <label class="md-control-label"></label>
                                    </div>
                                </div>
                                <div class="md-form-group">
                                    ...
                                    <div>
                                        <input id="unit_price" class="md-form-control" type="text" name = "unit_price">
                                        <label class="md-control-label"></label>
                                    </div>
                                </div>
                                <div class="md-form-group">
                                    ...
                                    <div>
                                        <input id="quantity" class="md-form-control" type="text" name = "quantity" required>
                                        <label class="md-control-label"></label>
                                    </div>
                                </div>
