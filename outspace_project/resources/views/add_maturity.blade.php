            ...
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
                    <div class="demo-form-wrapper">
                        <form class="form" method="post" action="{{ route('route_drp') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name = "maturity_date" data-provide="datepicker" data-date-today-highlight="true">
                            </div>
