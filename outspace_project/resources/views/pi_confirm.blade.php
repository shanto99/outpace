                ...
                <div class="col-sm-8 col-sm-offset-3 col-md-4 col-md-offset-4">
                    <div class="demo-form-wrapper">
                        ...
                        <div class="md-form-group">
                            ...
                            <input id="pi_id" name="pi_id" class="md-form-control" type="text" value="{{ $pi_detail->pi_id }}">
                            <label class="md-control-label"></label>
                        </div>
                        <div class="md-form-group">
                            <label for="pi_date">PI Date</label>
                            <input id="pi_date" class="md-form-control" type="text" value="{{ $pi_detail->pi_date }}">
                            <label class="md-control-label"></label>
                        </div>
                        <div class="md-form-group">
                            <label for="offer_validity">Offer Validity</label>
                            <input id="offer_validity" class="md-form-control" type="text" value="{{ $pi_detail->offer_validity }}">
                            <label class="md-control-label"></label>
                        </div>
                        <div class="md-form-group">
                            ...
                            <div>
                                <select id="select_a_buyer" class="md-form-control">
                                    ...
                                    @foreach($buyers as $buyer)
                                        <option value = "{{ $buyer->buyer_id }}"<?= $buyer->buyer_id == $pi_detail->buyer_id ? 'selected="selected"' : '';?>>{{ $buyer->buyer_name }}</option>
                                    @endforeach
                                </select>
                                <label class="md-control-label"></label>
                            </div>
                            ...
                            <div>
                                <select id="select_a_bank" class="md-form-control">
                                    ...
                                    @foreach($banks as $bank)
                                        <option value = "{{ $bank->bank_id }}"<?= $bank->bank_id == $pi_detail->bank_id ? 'selected="selected"' : '';?>>{{ $bank->bank_name }}, {{ $bank->branch }}</option>
                                    @endforeach
                                </select>
                                <label class="md-control-label"></label>
                            </div>
                        ...
                        <div class="md-form-group">
                            ...
                            <input id="overdue_interest" class="md-form-control" type="text" value="{{ $pi_detail->overdue_interest }}" required>
                            <label class="md-control-label"></label>
                        </div>
                        <div class="md-form-group">
                            <label for="payment_period">Payment Period</label>
                            <input id="payment_period" class="md-form-control" type="text" value="{{ $pi_detail->payment_period }}">
                            <label class="md-control-label"></label>
                        </div>
                        <div id="PItablediv">
                        ...
                        <button class="btn btn-primary btn-block" type="submit" id="save_pi">Save & Confirm</button>
...
<script>
    ...
    $('#save_pi').click(function () {
        var rowdata = [];
        var itemsTable = document.getElementById('PITable');
        var pi_id = document.getElementById('pi_id').value;
        var pi_date = document.getElementById('pi_date').value;
        var date = new Date(pi_date);
        var PI_date = (date.getFullYear() + '-' + date.getMonth() + '-' + date.getDate());
        var offer_validity = new Date(document.getElementById('offer_validity').value);
        var offer_date = (offer_validity.getFullYear() + '-' + offer_validity.getMonth() + '-' + offer_validity.getDate());
            ...
            if (countLoop < 1) {
                ...
                if (rowdata.length > 1) {
                    ...
                    $.ajax({
                        ...
                        data: {rowdata: rowdata, pi_id: pi_id, status: "0"},
                        success: function (data) {
                            countLoop = 1;
                        }
                    });
